...
import { render, cleanup, waitForElement, fireEvent, prettyDOM, getByText, getAllByTestId, getByAltText, getByPlaceholderText, getByTestId, queryByText } from "@testing-library/react";
...
describe("Application", () => { 
  ...
  //   afterEach(cleanup) not working -- Visually verified 
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    await fireEvent.click(getByText(appointment, "Save"));
